...
expect "Record with BookID=1005 has been added to the database"
expect "exit"
...
expect "Record with BookID=1006 has been added to the database"
expect "exit"
...
expect "Record with BookID=1007 has been added to the database"
expect "exit"

send "add 1008|978-0-77777777-7|Matemáticas|Cambridge\r"
expect "Record with BookID=1008 has been added to the database"
expect "exit"
...
puts "\n***************************************************"
puts " TEST PASSED: Reuse of deleted books with worst_fit works perfectly!"
puts "***************************************************"
